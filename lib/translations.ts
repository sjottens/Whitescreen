...
export const translations = {
  en: {
    ...
    privacy_cookies_text: 'We do not use cookies or any form of local storage to track your behavior.',
    privacy_contact: 'Contact Us',
    privacy_contact_text: 'Have privacy concerns? Contact us at privacy@screenglow.eu',
  ...
  nl: {
    ...
    privacy_cookies: 'Cookies',
    privacy_cookies_text: 'We gebruiken geen cookies of andere vormen van lokale opslag om je gedrag bij te houden.',
    privacy_contact: 'Neem Contact Op',
    privacy_contact_text: 'Privacy vragen? Neem contact met ons op via privacy@screenglow.eu',
    
    // Use Cases & Labels
    use_cases: 'Gebruiksscenario\'s',
    display_testing: 'Schermtest',
    screen_cleaning: 'Schermreiniging',
    photography_lighting: 'Fotografieverlichting',
    dead_pixel_detection: 'Detectie Dode Pixels',
    ...
    video_call_lighting: 'Videobelverlichting',
    professional_meetings: 'Professionele Vergaderingen',
    monitor_calibration: 'Monitorkalibratie',
    brightness_testing: 'Helderheidstests',
    gamma_verification: 'Gammaverificatie',
    accessibility_testing: 'Toegankelijkheidstests',
  ...
  es: {
    ...
    privacy_cookies: 'Cookies',
    privacy_cookies_text: 'No usamos cookies ni ninguna forma de almacenamiento local para rastrear tu comportamiento.',
    privacy_contact: 'Contáctanos',
    privacy_contact_text: '¿Preguntas de privacidad? Contáctanos en privacy@screenglow.eu',
    
    // Use Cases & Labels
    use_cases: 'Casos de Uso',
    display_testing: 'Prueba de Pantalla',
    screen_cleaning: 'Limpieza de Pantalla',
    photography_lighting: 'Iluminación Fotográfica',
    ...
    video_effects: 'Efectos de Vídeo',
    chroma_key: 'Clave de Croma',
    video_production: 'Producción de Vídeo',
    streaming: 'Transmisión',
    creative_lighting: 'Iluminación Creativa',
    video_call_lighting: 'Iluminación de Videollamadas',
    professional_meetings: 'Reuniones Profesionales',
    monitor_calibration: 'Calibración de Monitor',
