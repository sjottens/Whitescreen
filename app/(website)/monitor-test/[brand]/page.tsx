// app/(website)/monitor-test/[brand]/page.tsx - English-only monitor brand tests
// Routes: /monitor-test/asus, /monitor-test/lg, etc. (no locale prefix for English)

import { Metadata } from 'next';
import Link from 'next/link';
import Breadcrumbs from '@/components/layout/breadcrumbs';
import { generateMetadata as generateBaseMetadata } from '@/lib/seo';
import { breadcrumbSchemaMultilingual } from '@/lib/seo';
