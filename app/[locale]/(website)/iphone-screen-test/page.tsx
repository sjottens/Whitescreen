        ...
        <div className="container max-w-4xl">
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                { path: '/screen/red-screen/fullscreen', title: 'Red Screen', desc: 'Test red pixel quality and dead pixels' },
          ...
          <div className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6">{translate('iphone_specific_questions' as any)}</h2>
